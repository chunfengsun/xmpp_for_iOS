...
//    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(faceSendButton:) name:@"faceSendButton" object:nil];
...
//-(void)faceSendButton:(NSNotification *)note
//{
//    
//    
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell btnWithMessageString:message.body isOutgoing:message.isOutgoing];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGSize size = [message.body sizeWithFont:[UIFont systemFontOfSize:13] constrainedToSize:CGSizeMake(180, MAXFLOAT)];
