...
static NSMutableArray *_allArray;
...
+(void)initialize
{
    ...
    _dict = [NSMutableDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle]pathForResource:@"expression" ofType:@"plist"]];
    
    for (NSString *str in _dict) {
...
//    NSString *emojiString = [NSString stringWithFormat:@"%@.png",self.text];
    ...
    UIImage *image = [UIImage imageNamed:[_dict objectForKey:self.text]];
    if (image)
    {
